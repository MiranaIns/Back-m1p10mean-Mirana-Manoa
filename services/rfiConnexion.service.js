...
const collectionName = 'responsable_financier_connexion';
...
async function findUtilisateurByUtilisateurConnexionId(idUtilisateurConnection){
    try {
        return db.then((db) => {
            const collection = db.collection("responsable_financier");
            return new Promise((resolve, reject) => {
...
module.exports = RfiConnexionService;