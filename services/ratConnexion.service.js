...
const collectionName = 'responsable_atelier_connexion';
...
async function findUtilisateurByUtilisateurConnexionId(idUtilisateurConnection){
    try {
        return db.then((db) => {
            const collection = db.collection("responsable_atelier");
            return new Promise((resolve, reject) => {
...
module.exports = RatConnexionService;